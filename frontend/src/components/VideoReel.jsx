    ...
    >
      ...
      {!isLoaded && (
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="w-8 h-8 border-2 border-[hsl(352_33%_59%)] border-t-transparent rounded-full animate-spin" />
        </div>
      )}
      ...
      {hasError && (
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[hsl(0_0%_12%)] to-[hsl(0_0%_8%)]">
          <div className="text-center p-4">
            <div className="w-16 h-16 mx-auto mb-3 rounded-full bg-[hsl(352_33%_59%/0.1)] flex items-center justify-center">
              <svg className="w-8 h-8 text-[hsl(352_33%_59%)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
